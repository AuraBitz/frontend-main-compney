...
import { GetTransactionById } from "@/services/api/transactions.api";
...
export default function ViewTransactionPage() {
  ...
  const config = useMemo(
    () =>
      initialData ? buildTransactionFormConfig("view", initialData) : null,
    [initialData]
  );
  ...
  return (
    <DynamicForm
      ...
      onEdit={() => router.push(`/transaction-master/${id}/edit`)}
    />
  );
}
