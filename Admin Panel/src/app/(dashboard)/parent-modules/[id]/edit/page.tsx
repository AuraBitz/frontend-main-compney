...
import { GetParentModuleById, UpdateParentModule } from "@/services/api/parent-modules.api";

export default function EditParentModulePage() {
  ...
  const config = useMemo(
    () =>
      initialData ? buildParentModuleFormConfig("edit", initialData) : null,
    [initialData]
  );
  ...
  return (
    <DynamicForm
      ...
      loading={loading}
      onSubmit={async (data) => {
        await UpdateParentModule(id, mapFormToParentModulePayload(data));
