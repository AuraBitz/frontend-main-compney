...
import { GetProjectById, UpdateProject } from "@/services/api/projects.api";
...
export default function EditProjectPage() {
  ...
  const config = useMemo(
    () =>
      initialData
        ? buildProjectFormConfig("edit", initialData, formOptions)
        : null,
  ...
  return (
    <DynamicForm
      ...
      loading={loading}
      onSubmit={async (data) => {
        await UpdateProject(id, mapFormToProjectPayload(data));
