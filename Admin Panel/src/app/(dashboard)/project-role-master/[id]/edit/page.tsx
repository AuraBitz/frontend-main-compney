...
export default function EditProjectRolePage() {
  ...
  const config = useMemo(
    () =>
      initialData ? buildProjectRoleFormConfig("edit", initialData) : null,
    [initialData]
  );
  ...
  return (
    <DynamicForm
      ...
      loading={loading}
      onSubmit={async (data) => {
        await UpdateProjectRole(id, mapFormToProjectRolePayload(data));
