...
export default function EditProjectPermissionPage() {
  ...
  const config = useMemo(
    () =>
      initialData
        ? buildProjectPermissionFormConfig("edit", initialData, formOptions)
        : null,
  ...
  return (
    <DynamicForm
      ...
      loading={loading}
      onSubmit={async (data) => {
        await UpdateProjectPermission(id, mapFormToProjectPermissionPayload(data));
